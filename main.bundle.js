...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__routeComponents_select_time_select_time_component__ = __webpack_require__("../../../../../src/app/routeComponents/select-time/select-time.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__routeComponents_input_details_input_details_component__ = __webpack_require__("../../../../../src/app/routeComponents/input-details/input-details.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__routeComponents_confirmation_confirmation_component__ = __webpack_require__("../../../../../src/app/routeComponents/confirmation/confirmation.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_9__routeComponents_select_time_select_time_component__["a" /* SelectTimeComponent */],
            __WEBPACK_IMPORTED_MODULE_10__routeComponents_input_details_input_details_component__["a" /* InputDetailsComponent */],
            __WEBPACK_IMPORTED_MODULE_11__routeComponents_confirmation_confirmation_component__["a" /* ConfirmationComponent */]
        ],
        imports: [
...
var SelectDateComponent = (function () {
    function SelectDateComponent(_activeRoute, _router, _webSrv) {
    ...
    SelectDateComponent.prototype.ngOnInit = function () {
        ...
        this._activeRoute.queryParams.subscribe(function (params) {
            ...
            if (_this.trainer_key == undefined) {
                ...
                _this._webSrv.getTrainerScheduleTillEOM(_this.trainer_key, 0)
    ...
    // HELPERs 
    SelectDateComponent.prototype.get_sched_helper_1 = function (day_num) {
        switch (day_num) {
            case 0:
                return 'sunday';
            case 1:
    ...
    SelectTimeComponent.prototype.ngOnInit = function () {
        ...
        if (this.selected_date == null) {
            ...
            for (var appointment_block_raw in this.trainer_appointments_raw) {
                console.log(this.trainer_appointments_raw[appointment_block_raw]);
            ...
            for (var key in this.trainer_availability_obj) {
                if (this.trainer_appointments_obj[key] == null) {
                    console.log(key);
                    var startHumanTime = parseInt(key) / 1800;
                    var availSlotObj = {
                        startTimeMs: key,
                        startTimeHuman: this.getHumanTime(key)
                    };
            ...
            console.log(this.avail_slots_html);
        }
    };
...
var SelectTrainerComponent = (function () {
    ...
    SelectTrainerComponent.prototype.selectTrainer = function (trainer) {
        console.log(trainer);
        // var some = this._webSrv.selectTrainerCall(trainer);
        this._router.navigate(['select-date']);
    };
...
var WebService = (function () {
    ...
    WebService.prototype.getTrainerScheduleTillEOM = function (trainer_key, week) {
        console.log(trainer_key, 'sending this');
        return this._http.get('https://us-central1-remindly-dev.cloudfunctions.net/get_schedule_till_end_of_month?trainer_key=' + trainer_key + '&week=' + week)
            .map(function (res) { return res; });
    };
